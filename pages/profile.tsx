...
export default async function Profile() {
  ...
  const { fetch, error, isFetching } = useWeb3Transfer({
    ...
    receiver: userAd,
    type: "erc20",
    contractAddress: w3sTokenAddress,
  });

  const withdrawTokens = () => {
    const withdrawTokensOptions = {
      address: w3sBalanceAddress,
      function_name: "withdraw",
      abi: BalanceABI.abi,
      params: { amount: userW3ST },
    };

    // "withdraw" from moralis - subtracting the tokens from Moralis DB
    // fetch({ params: withdrawTokensOptions });

    // transfer tokens from w3sToken bank (Calvin's wallet rn)
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="web3swim is a content creation monetization videoverse for web3"
        />
      ...
      <ProfileOuterCon>
        <ProfileInnerCon>
          {user ? (
            <>
              <Col1>
                ...
                <div style={{ display: "flex", height: "60px" }}>
                  ...
                  <h1 style={{ fontWeight: "100", marginLeft: "10px" }}>
                    {!editingHandle ? (
                      ...
                      <input value={handle} onChange={inputHandler}></input>
                    )}
                  </h1>
                  {!editingHandle ? (
                    <AppRegistrationIcon
                ...
                >
                  ...
                  <h2 style={{ fontWeight: "100", marginLeft: "10px" }}>
                    {!editingChannelName ? (
                      <div style={{ cursor: "pointer" }}>{userChName}</div>
                    ) : (
                      <input
                        value={channelName}
                ...
                >
                  ...
                  <h4 style={{ fontWeight: "100", marginLeft: "10px" }}>
                    {!editingChannelDescription ? (
                      <div style={{ cursor: "pointer" }}>{userChDes}</div>
                    ) : (
                      <input
                ...
                >
                  ...
                  <h4 style={{ fontWeight: "100", marginLeft: "10px" }}>
                    {
                      !editingChannelTag ? (
                        <div style={{ cursor: "pointer" }}>{userChTag}</div>
                      ) : (
                        <FormControl
                          style={{
                            background: "white",
                  ...
                  {streamingEnabled === true ? (
                    <StreamingStatus>
                      <StatusWrapper>
                        ...
                        <StatusInnerText>Streaming is Enabled</StatusInnerText>
                      </StatusWrapper>
                    </StreamingStatus>
                  ) : (
                    <StreamingStatus>Streaming is Not Enabled</StreamingStatus>
                  )}
              ...
              <Col2>
                ...
                <WalletBalanceWrapper>
                  <WalletBalanceTokenIcon>
                    <Image src={PolygonMaticLogo} alt="Polygon Matic Logo" />
                  </WalletBalanceTokenIcon>
                  <WalletBalanceTokenNum>
          ...
          null
                ...
                {userW3ST > 9 ? (
                  <WithdrawStatusEnabled onClick={() => withdrawTokens()}>
                    <StatusWrapper>
                      <StatusMonetizationIcon>
                        <Image
                          src={PolygonMaticLogo}
                      ...
                      <StatusInnerText>Withdraw Your W3S</StatusInnerText>
                    </StatusWrapper>
                  </WithdrawStatusEnabled>
                ) : (
                  <WithdrawStatusDisabled>
                    <StatusWrapper>
                      ...
                      <StatusInnerText>You Need 10+ W3S</StatusInnerText>
                    </StatusWrapper>
                  </WithdrawStatusDisabled>
                )}
              </Col2>
