...
export const StatusMonetizationIcon = styled.div`
  ...
  margin-right: 10px;
  margin-top: 2px;
  filter: invert(99%) sepia(22%) saturate(4107%) hue-rotate(301deg)
    brightness(124%) contrast(104%);
  /* top: 50%;
    left: 50%;
    transform: translate(-50%,-50%); */
  /* vertical-align: text-top; */
...
export const StatusInnerText = styled.p`
  position: relative;
`;
...
export const WithdrawStatusEnabled = styled.button`
  background: none;
  border: none;
  height: 50px;
  width: 260px;
